...
import com.proyectogentile.Gentile.Dto.dtoExperiencia;
import com.proyectogentile.Gentile.Entity.Experiencia;
import com.proyectogentile.Gentile.Security.Controller.Mensaje;
import com.proyectogentile.Gentile.Service.SExperiencia;
...
public class CExperiencia {
    ...
    public ResponseEntity<?> create(@RequestBody dtoExperiencia dtoexp){
       ...
       if(sExperiencia.existsByNombreE(dtoexp.getNombreE()))
           return new ResponseEntity(new Mensaje("Este campo ya existe"), HttpStatus.BAD_REQUEST);
